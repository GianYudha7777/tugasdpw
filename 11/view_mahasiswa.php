...
<html lang="id">
<head>
    <meta charset="UTF-8"><title>Data Mahasiswa - Modul 11</title>
                ...
                <tbody class="divide-y divide-slate-100 text-sm text-slate-600">
                    ...
                    while ($data = mysqli_fetch_assoc($result)) { ?>
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            ...
                            <td class="py-4 px-6 font-medium"><?= $data['namaMhs']; ?></td>
                            <td class="py-4 px-6"><span class="px-2.5 py-0.5 rounded-full text-xs font-medium bg-indigo-50 text-indigo-700"><?= $data['prodi']; ?></span></td>
                            <td class="py-4 px-6 text-slate-500"><?= $data['alamat']; ?></td>
                            <td class="py-4 px-6 text-slate-500"><?= $data['noHP']; ?></td>
